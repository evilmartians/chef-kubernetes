...
default['kubernetes']['addons']['kubedns']['version']            = '1.14.8'
...
default['kubernetes']['addons']['coredns']['version']            = '1.1.0'
...
default['kubernetes']['addons']['coredns']['node_selector']      = 'evl.ms/role=system'
