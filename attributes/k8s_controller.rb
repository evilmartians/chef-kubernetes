...
default['kubernetes']['controller_manager']['cloud_config']                     = node['kubernetes']['cloud_config']
default['kubernetes']['controller_manager']['cloud_provider']                   = node['kubernetes']['cloud_provider']
...
default['kubernetes']['controller_manager']['feature_gates']                    = node['kubernetes']['feature_gates'].join(',')
