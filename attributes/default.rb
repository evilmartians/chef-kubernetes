...
default['kubernetes']['ssl']['keypairs']                    = %w(apiserver ca-cluster_signing ca-service_account ca-requestheader front_proxy_client kubelet_client ca-etcd_server ca-etcd_peer etcd_server etcd_peer)
